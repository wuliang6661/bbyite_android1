...
import com.baibeiyun.bbyiot.view.swifrefresh.SwifrefreshOrLoadmore;
import com.baibeiyun.bbyiot.module.test.adapter.TempAdapter;
...
public class ApiShowFragment extends Fragment {
    ...
    @BindView(R.id.tempfrag_swiperefresh)
    SwifrefreshOrLoadmore refreshLayout;
    ...
    private void initRefreshLayout() {
        ...
        refreshLayout.setOnRefreshListener(new SwifrefreshOrLoadmore.OnRefreshListener() {
            @Override
        ...
        //在这里新增下拉刷新方法
        refreshLayout.setOnBottomRefreshListenrer(new SwifrefreshOrLoadmore.OnBottomRefreshListener() {
            @Override
