...
public class ShopHardwareAdapter extends BaseAdapter {

    private List<GoodsShopResponse> mList = new ArrayList<>();
    private Context context;

    public ShopHardwareAdapter(Context context) {
    ...
    public List<GoodsShopResponse> getData() {
        return mList;
    }
    ...
    private void setTag1(TextView textView, List<GoodsShopResponse.ItemsBean> list) {
        SpannableStringBuilder builder = new SpannableStringBuilder("");

        for (GoodsShopResponse.ItemsBean itemsBean : list) {
