 ...
 * 数值设备 --->  历史数据
 */
public class NumHistoryDataFragment extends BaseFragment<NumHistoryPresenter> implements NumHistoryContract.View {

    @BindView(R.id.frg_num_history_data_linechart)
    MyLineChart mLineChart;

    @BindView(R.id.frg_num_history_data_tv_start_time)
    TextView tv_start_time;

    @BindView(R.id.frg_num_history_data_tv_end_time)
    ...
    protected int getContentViewLayoutID() {
        ...
        return R.layout.frg_num_history_data;
    }
    ...
    protected void initViewsAndEvents() {
        ...
        startDate = DateUtils.stamp2String(currentTimeStamp - 60 * 60 * 1000, "yyyy-MM-dd HH:mm:ss");
        endDate = DateUtils.stamp2String(currentTimeStamp, "yyyy-MM-dd HH:mm:ss");
    ...
    void getData() {
        ...
        mPresenter.getDataHisDataChart(2, startDate, endDate);
    }
    ...
    @OnClick({R.id.frg_num_history_data_tv_start_time, R.id.frg_num_history_data_tv_end_time
    })
    void click(View view) {
        switch (view.getId()) {
            case R.id.frg_num_history_data_tv_start_time:
                DateSelectUtil22.showDatePopu(getActivity(), "选择开始时间", new DateSelectUtil22.SelectListener() {
                    @Override
            ...
            case R.id.frg_num_history_data_tv_end_time:
                DateSelectUtil22.showDatePopu(getActivity(), "选择结束时间", new DateSelectUtil22.SelectListener() {
                    @Override
                    public void onDateSelect(String dataString) {
                        if (DateUtils.getTimeStamp(dataString, "yyyy-MM-dd HH:mm:ss") > DateUtils.getCurrentTimeStamp()) {
...
//                }
            ...
            lineDataSet.setColor(getResources().getColor(StatisticAnalysisActivityNew.lineColorArr[0]));//设置折线图的颜色
