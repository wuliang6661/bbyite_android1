...
public class MyPullToRefreshLayout extends RelativeLayout {
    // 初始状态
    ...
    public MyPullToRefreshLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    private class AutoRefreshAndLoadTask extends
        ...
        protected void onPostExecute(String result) {
            ...
            // 刷新操作
            if (mListener != null)
                mListener.onRefresh(MyPullToRefreshLayout.this);
            hide();
        }
    ...
    public interface OnRefreshListener {
         ...
         * 刷新操作
         */
        void onRefresh(MyPullToRefreshLayout pullToRefreshLayout);

        /**
         * 加载操作
         */
        void onLoadMore(MyPullToRefreshLayout pullToRefreshLayout);
    }
