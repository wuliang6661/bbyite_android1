...
public class SwipeListView extends ListView {
    ...
    public SwipeListView(Context context) {
        super(context);
//        mRightViewWidth = DensityUtils.dip2px(context, 240);
    }
...
//        mRightViewWidth = DensityUtils.dip2px(context, 240);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SwipeListView, 0, 0);

        mRightViewWidth = (int) a.getDimension(R.styleable.SwipeListView_slv_right_view_width, SizeUtils.dp2px(context, 80));


        LogUtils.w("w:" + mRightViewWidth + ",or:" + SizeUtils.dp2px(context, 240));
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (motionPosition >= 0 && motionPosition < getCount()) {
    ...
    public void hiddenRightCurrent() {
