package com.baibeiyun.bbyiot.view.swifrefresh;
 ...
 * </p>
 */
public class SwifrefreshOrLoadmore extends ViewGroup implements NestedScrollingParent,
    ...
    private static final String LOG_TAG = SwifrefreshOrLoadmore.class.getSimpleName();
     ...
     * @param context
     */
    public SwifrefreshOrLoadmore(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public SwifrefreshOrLoadmore(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//                     (width / 2 + circleWidth / 2), childHeight/2 + circleHeight);
    ...
    /**
     * Set a callback to override {@link SwifrefreshOrLoadmore#canChildScrollUp()} method. Non-null
    ...
    /**
     * Classes that wish to override {@link SwifrefreshOrLoadmore#canChildScrollUp()} method
     * behavior should implement this interface.
     */
    public interface OnChildScrollUpCallback {
        /**
         * Callback that will be called when {@link SwifrefreshOrLoadmore#canChildScrollUp()} method
         ...
         */
        boolean canChildScrollUp(SwifrefreshOrLoadmore parent, @Nullable View child);
    }
}
