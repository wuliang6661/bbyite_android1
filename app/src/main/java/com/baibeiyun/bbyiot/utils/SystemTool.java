...
public final class SystemTool {
    public static final String SETTING_FILE = "wframe_preference";
    ...
    public static boolean checkOnlyWifi(Context context) {
        if (SpUtils.put( SETTING_FILE, ONLY_WIFI)) {
    ...
    private static void openApk(Context context, File apkfile) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) { //24 : 判读版本是否在7.0以上
            ...
            Uri apkUri = FileProvider.getUriForFile(context, "com.leyiquery.dianrui.FileProvider", apkfile);
            LogUtils.w("----------------------2-------------------");
